  ...
  var bootsnav = {
    ...
    event: function () {
      ...
      if (getNav.hasClass('brand-center')) {
        ...
        //Generate HTML for first list 生成第一個列表生成 HTML
        createHTML(firstList)
        $postsList.html(ListHTML)
        index.find('ul.nav').first().addClass('navbar-left')

        //Generate HTML for second list 生成第二個列表生成 HTML
    ...
    // ------------------------------------------------------------------------------ //
    // Change dropdown to hover on dekstop下拉菜單
    // ------------------------------------------------------------------------------ //
    hoverDropdown: function () {
      ...
      if (getWindow < 767) {
        // Height of scroll navigation sidebar側邊欄的高度
        $('.scroller').css('height', 'auto')

        // Disable mouseenter event 禁用 mouseenter 事件
        ...
        // Enable click event 啟用點擊事件
        $('nav.navbar.bootsnav ul.nav').each(function () {
          $('.dropdown-menu', this).addClass('animated')
          $('.dropdown-menu', this).removeClass(getOut)

          // Dropdown Fade Toggle 下拉淡入淡出切換
          ...
          // Hidden dropdown action 隱藏的下拉動作
          ...
          $('nav.navbar.bootsnav ul.nav').each(function () {
            ...
            $('.col-menu').each(function () {
              ...
              $('.title', this).on('mouseenter', function () {
                $(this).closest('.col-menu').find('.content').stop().fadeIn()
